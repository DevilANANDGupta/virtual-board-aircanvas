...
# paintWindow = cv2.rectangle(paintWindow, (520,1), (615,65), colors[4], -1)
...
# cv2.putText(paintWindow, "WHITE", (580, 33), cv2.FONT_ITALIC, 0.5, (150,150,150), 2, cv2.LINE_AA)
# cv2.namedWindow('Paint', cv2.WINDOW_AUTOSIZE)
...
while True:
    ...
    # cv2.putText(frame, "WHITE", (580, 33), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (150,150,150), 2, cv2.LINE_AA)
